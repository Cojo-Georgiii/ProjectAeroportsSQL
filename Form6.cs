...
namespace SQLProjectAeroport
{
    public partial class Form6 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "insert into Pasageri values (" +textBox1.Text+ ",'" +textBox2.Text+ "','" +textBox3.Text+ "','" +textBox4.Text+ "'," +textBox5.Text+ "," +comboBox1.SelectedValue.ToString()+ ")";
            cmd.ExecuteNonQuery();
            Global.con.Close();
        ...
        {
            /* new Global();
             //dataGridView2.DataSource = Global.dst;
             // dataGridView2.DataMember = "iii";
             //SqlCommand cmdd = new SqlCommand("select Companie_Aeriana , Oras_Plecare , Oras_Sosire  from  Zboruri ", Global.con);
             //dataGridView2.DataSource = cmdd;
             Global.con.Open();
             SqlCommand cmd = Global.con.CreateCommand();
             cmd.CommandType = CommandType.Text;
             cmd.CommandText = "select Companie_Aeriana , Oras_Plecare , Oras_Sosire  from  Zboruri where id_Zboruri = " +comboBox1.SelectedValue.ToString()+"";
             dataGridView2.DataSource = cmd.ExecuteNonQuery();
             Global.con.Close();*/
